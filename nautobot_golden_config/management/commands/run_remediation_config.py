"""Add the run_remediation_config command to nautobot-server."""
...
class Command(BaseCommand):
    ...
    help = "Run Job to generate your remediation configuration from Golden Config Plugin."

    def add_arguments(self, parser):
        """Add arguments for run_remediation_config."""
    ...
    def handle(self, *args, **kwargs):
        """Add handler for run_remediation_config."""
        job_class = get_job("plugins/nautobot_golden_config.jobs/RemediationJob")
